    ...
    <main className={styles.authhome}>
      <section className={styles.leftSide}>
        ...
        >
          <svg
            fill="#000000"
            viewBox="0 -8.55 103.623 103.623"
